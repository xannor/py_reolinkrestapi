...
from async_reolink.rest.connection.mixin import Encryption
...
parser = argparse.ArgumentParser(description="Get Live Abilities from Camera")
parser.add_argument("hostname", help="Hostname of device")
parser.add_argument(
    "-p", "--port", type=int, help="Alternate port for api interface", dest="port"
)
parser.add_argument(
    "--ssl",
    action="store_const",
...
parser.add_argument(
    "-P", "--pass", "--password", help="Password", default=None, dest="password"
)
